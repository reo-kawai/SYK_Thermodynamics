# CLAUDE.md - SYK Thermodynamics Research Project
...
- **English**: Use exclusively for project management files (CLAUDE.md, configuration files, code comments, and technical documentation)
