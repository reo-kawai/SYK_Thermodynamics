% ---------------------------------------------------------------
% macros.tex
% Shared notation for all documents under notes_tex.
% Documents that discuss the same physics MUST input this file so that
% every shared symbol has literally the same definition.
%
...
\newcommand{\Sadv}{\Sigma^{A}}            % advanced self-energy
\newcommand{\Sgtr}{\Sigma^{>}}            % greater self-energy
\newcommand{\Slss}{\Sigma^{<}}            % lesser self-energy

% --- Model parameters -------------------------------------------
\newcommand{\Jsyk}{\mathcal{J}}           % SYK four-fermion coupling
